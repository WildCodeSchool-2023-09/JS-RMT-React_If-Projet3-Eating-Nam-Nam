    ...
    <div className="terms-square">
      <div className="terms">
        ...
        <p>
          ...
          conditions. Do not continue to use Eating Nam Name if you do not agree
          ...
          with and subject to, prevailing law of fr. Any use of the above
          terminology or other words in the singular, plural, capitalization
          and/or he/she or they, are taken as interchangeable and therefore as
          referring to same. <h5>Cookies </h5>We employ the use of cookies. By
          accessing Eating Nam Name, you agreed to use cookies in agreement with
          the Eating Nam nam's Privacy Policy. Most interactive websites use
          ...
          affiliate/advertising partners may also use cookies. <h5>License </h5>{" "}
          Unless otherwise stated, Eating Nam nam and/or its licensors own the
          intellectual property rights for all material on Eating Nam Name. All
          intellectual property rights are reserved. You may access this from
          Eating Nam Name for your own personal use subjected to restrictions
          set in these terms and conditions. You must not: Republish material
          from Eating Nam Name Sell, rent or sub-license material from Eating
          Nam Name Reproduce, duplicate or copy material from Eating Nam Name
          Redistribute content from Eating Nam Name This Agreement shall begin
          ...
          information in certain areas of the website. Eating Nam nam does not
          filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of Eating
          Nam nam,its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, Eating Nam nam shall not be
          ...
          and/or appearance of the Comments on this website. Eating Nam nam
          ...
          activities or unlawful activity. You hereby grant Eating Nam nam a
          ...
          link requests from these organizations if we decide that: (a) the link
          ...
          compensates the absence of Eating Nam nam; and (d) the link is in the
          ...
          Eating Nam nam. Please include your name, your organization name,
          ...
          format of content on the linking party's site. No use of Eating Nam
          nam's logo or other artwork will be allowed for linking absent a
          trademark license agreement. <h5>iFrames</h5> Without prior approval
          and written permission, you may not create frames around our Webpages
          that alter in any way the visual presentation or appearance of our
          Website. Content Liability We shall not be hold responsible for any
          content that appears on your Website. You agree to protect and defend
          ...
          date. <h5>Disclaimer</h5> To the maximum extent permitted by
          ...
          liability for fraud or fraudulent misrepresentation; limit any of our
          or your liabilities in any way that is not permitted under applicable
          law; or exclude any of our or your liabilities that may not be
          excluded under applicable law. The limitations and prohibitions of
          liability set in this Section and elsewhere in this disclaimer: (a)
